 	...
 	<div class="col-lg-10 my-auto">
 		<div class="card-group myShadow">
 			<div class="card rounded-left p-4" style="flex-grow:1.4;">
 				<h1 class="text-center font-weight-bold text-primary">Singn in to Acount</h1>
 				    <hr class="my-3">
 		...
 		<div class="card justify-content-center rounded-right myColor p-4">
 			...
 			<p class="text-center font-weight-bolder text-light lead">Enter your personal details and star. </p>
   ...
   <div class="row justify-content-center wrapper"id="register-box" style="display: none;">
 	<div class="col-lg-10 my-auto">
		 ...
		 <div class="card justify-content-center rounded-left myColor p-4">
 			...
 			<hr class="my-3 bg-light myHr">
 			<p class="text-center font-weight-bolder text-light lead">To keep connected with us please login with personal info. </p>
 			<button class="btn btn-outline-light btn-lg align-self-center font-weight-bolder mt-4 myLinkBtn"id="login-link">Sign In</button>
 			  ...
 			  <div class="card rounded-right p-4" style="flex-grow:1.4;">
 				<h1 class="text-center font-weight-bold text-primary">Creat Account</h1>
 				    <hr class="my-3">
				   ...
				   <div class ="input-group input-group-lg form-group">
 			        ...
 			        <input type="password" name="cpassword"id="cpassword" class="form-control rounded-0" placeholder="Confirm Password" required minlength="5">
						   ...
						   <div class="form-group">
 			           	<input type="submit" value="Sign Up" id="regsiter-btn" class="btn btn-primary btn-lg btn-block myBtn">
 			        </div>
 			     </form>
 			  </div>
		 ...
		 <div class="card justify-content-center rounded-left myColor p-4">
 			...
 			<div class="card rounded-right p-4" style="flex-grow:1.4;">
 				<h1 class="text-center font-weight-bold text-primary">Forgot Your Password</h1>
 				    <hr class="my-3">
					 <p class="lead text-center text-secondary"> To reset your password, enter the regester e-mail and we will send to you the reset instruction on your e-mail !</p>
